...
var debug = require('debug')('ifmcoin-js:lib:tx');
var nacl = null;
...
var Transaction = function () {
    ...
    _createClass(Transaction, [{
        ...
        value: function sign(keypair, trs) {
            ...
            var signerSecretKey = tou8(keypair.privateKey);
            signature = nacl.crypto_sign_detached(hash, signerSecretKey);
        ...
        value: function getBytes(trs, skipSignature, skipSecondSignature) {
            ...
            try {
                ...
                bb = new ByteBuffer(1 + 4 + 32 + 32 + 64 + 8 + 64 + 64 + assetSize, true);
    ...
    }, */ 
    {
        ...
        value: function verifyBytes(bytes, publicKey, signature) {
            ...
            try {
                ...
                var signatureUnit8Array = tou8(signatureBuffer);
                var publicKeyUnit8Array = tou8(publicKeyBuffer);
                ...
                res = nacl.crypto_sign_verify_detached(signatureUnit8Array, hash, publicKeyUnit8Array);
            } catch (e) {
                throw Error(e.toString());
            }
